...
export default function Search() {
    ...
    const submitHelper= async (searchTerm)=>{
        const response = await fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=5&q=${searchTerm}&type=video&key=AIzaSyBUUrsqNO-jsPXU5K8fPnVqFVYlZed3qfE`)
